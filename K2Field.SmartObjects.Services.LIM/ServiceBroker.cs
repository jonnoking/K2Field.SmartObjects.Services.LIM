...
namespace K2Field.SmartObjects.Services.LIM
{
    public class ServiceBroker : ServiceAssemblyBase
    {
        ...
        {
            base.Service.Name = "K2LiveInstanceManagement";
            base.Service.MetaData.DisplayName = "K2 Live Instance Management";
            base.Service.MetaData.Description = "K2 Live Instance Management";
